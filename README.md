...
__[Download Git Portable 2.11 Development Test 1][download]__
...
2. Download `PortableGit-*.7z.exe` from the [Git for Windows repository](https://github.com/git-for-windows/git/releases) and extract it to the `GitPortable\App\Git` directory.
 ...
 [download]: https://github.com/sheabunge/GitPortable/releases/download/v2.11-devtest.1/GitPortable_2.11_Development_Test_1.paf.exe
